    ...
    <div>
      <div>
        <section className="text-black-600 body-font pt-10">
          <Badge
            className=" py-3 px-5 rounded-lg bg-blue-100 text-blue-700  mx-7 text-2xl"
            variant="outline"
          >
            Apply Now!
          </Badge>
          ...
          <div className="flex flex-col gap-y-10 lg:flex-row px-6 py-8 flex-1">
            ...
            <div className="2/4">
              ...
              <p className="leading-7 [&:not(:first-child)]:mt-6 lg:text-2xl">
                ...
                University duly recognized by the Higher Education Commission of
                Pakistan. It is one of the oldest institutions in South Asia,
                which started as a school in 1885, became a college in 1943 and
